...
public class Form3 extends JFrame implements ActionListener {
	...
	String username;
	String bookName="The Lord of the Files";
	...
	public Form3(String username) {
		...
		bklb1.setIcon(new ImageIcon("image/1b.jpg"));
		...
		JLabel bWriter = new JLabel("by William Golding");
		bWriter.setFont(new Font("Bahnschrift", Font.PLAIN, 20));
		bWriter.setBounds(408, 188, 426, 46);
		panel.add(bWriter);
