...
public class AddUser extends JFrame implements ActionListener{
	...
	public AddUser(String username) {
		...
		imagelb.setIcon(new ImageIcon("image/adduser2.jpg"));
		panel.add(imagelb);
		
		registrationLb = new JLabel("Adding User");
		registrationLb.setFont(new Font("Tahoma", Font.BOLD, 20));
		registrationLb.setForeground(new Color(255, 255, 255));
		registrationLb.setBounds(700, 67, 268, 40);
		...
		cancelBtn.setBounds(643, 513, 148, 40);
		...
		signBtn.setText("Add User");
		signBtn.setFocusPainted(false);
		signBtn.setBounds(806, 513, 148, 40);
